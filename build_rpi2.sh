...
BUILDER="https://downloads.openwrt.org/releases/${BUILD_VERSION}/targets/bcm27xx/bcm2709/openwrt-imagebuilder-${BUILD_VERSION}-bcm27xx-bcm2710.Linux-x86_64.tar.xz"
